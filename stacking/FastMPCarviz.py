...
def reweight(chains,model_posts):
    ...
    for m in chains:
       ...
       # print("weights:")
        ...
        #print("reweight weights:")
        #print(weights)      #this has correct weights
    ...
    #print(full_stack) full stack is the full pd of d,a,b,c,logpost, weights(all 1.0) etc
    newchains['Reweighted'] = full_stack
    
    return newchains

# Run full computation to retrieve original and reweighted chains
def runbma(roots,models,chainDir,burnin,priors,temperature,cosmomc=False,
...
def runpseudobma(pbmaweights,roots,models,chainDir,burnin,priors,temperature,cosmomc=False,
        pars={'LCDM':['logA','ns','r','theta_MC_100','ombh2','omch2','tau']}, 
        estimator='harmonic'):
    '''
    Computes the model posteriors from the chains given in 'roots', using 
    ...
    # Construct reweighted chains
    #print('Reweighting chains')
    newchains = reweight(chains,pbmaweights)
...
def runstack(stackweights,roots,models,chainDir,burnin,priors,temperature,cosmomc=False,
        pars={'LCDM':['logA','ns','r','theta_MC_100','ombh2','omch2','tau']}, 
        estimator='harmonic'):
    '''
    Computes the model posteriors from the chains given in 'roots', using 
    ...
    # Construct reweighted chains
    #print('Reweighting chains')
    newchains = reweight(chains,stackweights)
...
def GRstat_Harmonic_check(roots,models,chainDir,burnin,temperature,prior,Rm1_stop=0.05, out_var=False, nmax='all'):
    ...
    for i in range(nch):
        ...
        ch_model_posts, ch_model_posts_err = model_post(models,ch_model_liks,prior)     #had to fix this line?
        for m in models:
    ...
    for m in models:
        ...
        Bs[m] = tmp
    B = Bs['lcdm1']                  #change made here, was originally just 'LCDM'
    print('\tB =',B/L)
    ...
    print('within-chain variance:',wc_vars['lcdm1'])         #change made here, was originally just 'LCDM'
    ...
    for m in models:
        Rs[m] = R
    print('R-1=',Rs['lcdm1']-1)                                         #change made here, was originally just 'LCDM'
