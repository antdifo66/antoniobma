    ...
    for k,r in enumerate(roots):
        ...
        for file in chainPath.iterdir():
            ...
            if (r in str(file) and '.txt' in str(file)
                ...
                #I'M PRETTY SURE ITS JUST THIS
                #IF I JUST PASS THE DATAFRAME INSTEAD OF THE FILES, OR FIGURE OUT HOW TO
                #RECREATE THE DATAFRAME FROM THE FILES, AND INPUT IT INTO 'DATA' HERE, IT SHOULD WORK
                
                #(AS LONG AS OTHER THINGS LIKE THE MINUS LOG POST AREN'T REQUIRED... which they are...)
                #fixed the above /\
